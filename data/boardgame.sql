...
(1, 1, 'Chiến thuật', 'product.php?code=BG\r\n'),
(2, 1, 'Kinh dị', 'product.php?code=BG'),
(3, 1, 'Suy luận', 'product.php?code=BG'),
(4, 1, 'Trò chơi bài', 'product.php?code=BG'),
(5, 1, 'Nhập vai', 'product.php?code=BG'),
(6, 2, 'Rubik 2x2', 'product.php?code=2x2'),
(7, 2, 'Rubik 3x3', 'product.php?code=3x3'),
(8, 2, 'Các loại khác', 'product.php?code=Other'),
...
(8, 'Battle for Rokugan (US)', 'Wargame', 1250000, '2-5', '5', '60 - 90', '14+', 'Conquer the realm and bring honor to your clan in Battle for Rokugan! This turn-based strategy game of conquest and mayhem puts players in the role of Rokugan daimyō struggling for control over the rich land of the Emerald Empire. Leaders must balance their resources, plan their attacks, and outwit their enemies to ensure their clan\'s victory. The land is there for the taking. The most honorable daimyō will win the day!', 'BG', 10, 'sp07.jpg', 0),
...
(10, 'Ma Sói Ultimate Deluxe ', 'Horror', 240000, '5 - 75', '11 - 15', '30 - 90', '8+', '    ', 'BG', 15, 'sp09.JPG', 0),
(11, 'Mèo Nổ - Exploding Kittens', 'Cardgame', 200000, '2 - 5', '4 - 5', '15', '7+', ' ', 'BG', 15, 'sp10.jpg', 0),
